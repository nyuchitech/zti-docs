...
description: >-
  Getting around Zimbabwe by road, air, and rail. Car rental, bus services, domestic flights, fuel availability, and driving tips for self-drive safari visitors.
...
<AccordionGroup>
  <Accordion icon="bus" title="Intercity Buses">
    ...
    **Popular Bus Operators by Route:**
    ...
    <Tip>
      **Traveler tip:** CAG buses are highly recommended by local travelers for the Victoria Falls and Kariba routes. ExtraCity Luxury is another popular choice known for good service. Book in advance during peak travel seasons (April-May and December-January).
    </Tip>
