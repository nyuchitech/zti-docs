                ...
                <div className="p-4">
                  ...
                  <div className="flex flex-wrap gap-1.5 mt-1.5">
                    ...
                    {est && renderStars(est.star_rating) && (
                      <span className="px-2 py-0.5 rounded-full text-xs font-medium bg-yellow-50 dark:bg-yellow-900/20 text-yellow-700 dark:text-yellow-300">{renderStars(est.star_rating)}</span>
                    )}
                    {b.pricerange && (
                      <span className="px-2 py-0.5 rounded-full text-xs font-medium bg-gray-100 dark:bg-gray-700 text-gray-600 dark:text-gray-300">{b.pricerange}/night</span>
                    )}
                    {est?.number_of_rooms && (
                      <span className="px-2 py-0.5 rounded-full text-xs font-medium bg-gray-100 dark:bg-gray-700 text-gray-600 dark:text-gray-300">{est.number_of_rooms} rooms</span>
                    )}
                  </div>
                  {b.description && (
              ...
              <div className="sticky top-0 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 px-6 py-4 flex justify-between items-start">
                <div>
                  ...
                  <div className="flex flex-wrap gap-1.5 mt-1.5">
                    <span className="px-2 py-0.5 rounded-full text-xs font-medium bg-primary-100 dark:bg-primary-900/40 text-primary-700 dark:text-primary-300">Accommodation</span>
                    {est && renderStars(est.star_rating) && (
                      <span className="text-yellow-400 text-sm">{renderStars(est.star_rating)}</span>
                    )}
