...
description: >-
  Guide to Zimbabwe's Eastern Highlands mountain range along the Mozambique border. Nyanga, Chimanimani, Bvumba, hiking trails, waterfalls, and cool-climate retreats.
...
<LocationMap lat={-18.9500} lng={32.7500} zoom={8} title="Eastern Highlands" />
