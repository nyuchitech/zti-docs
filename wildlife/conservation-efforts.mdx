...
description: >-
  Wildlife conservation in Zimbabwe. Anti-poaching efforts, community conservancies, species recovery programs, and how tourism supports protection of endangered animals.
...
<Accordion>
  <Accordion title="Poaching Crisis">
    **Scope:**
  ...
  <Accordion title="Human-Wildlife Conflict">
    **The Challenge:**
  ...
  <Accordion title="Snaring Crisis">
    **The Threat:**
  ...
  <Accordion title="Habitat Loss & Fragmentation">
    **Pressure Points:**
  ...
  <Accordion title="Climate Change Impacts">
    **Effects on Wildlife:**
...
<Accordion>
  <Accordion title="Zimbabwe Parks & Wildlife Management Authority (ZimParks)">
  ...
  <Accordion title="Painted Dog Conservation (PDC)">
  ...
  <Accordion title="International Anti-Poaching Foundation (IAPF)">
  ...
  <Accordion title="Wildlife & Environment Zimbabwe (WEZ)">
  ...
  <Accordion title="BirdLife Zimbabwe">
  ...
  <Accordion title="Zimbabwe Elephant Nursery">
