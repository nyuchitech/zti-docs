...
<Card title="Become a Verified Local Expert" icon="badge-check">
  ...
  <form action="https://formspree.io/f/xvgeropp" method="POST" className="space-y-4">
    <input type="hidden" name="_subject" value="Local Expert Application - Zimbabwe Travel Info" />
    <input type="hidden" name="form_type" value="expert_application" />

    <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
      <div>
        <label htmlFor="expert_name" className="block text-sm font-medium mb-1">Full Name *</label>
        <input
          type="text"
          name="name"
          id="expert_name"
      ...
      <div>
        <label htmlFor="expert_email" className="block text-sm font-medium mb-1">Email Address *</label>
        <input
          type="email"
          name="email"
          id="expert_email"
    ...
    <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
      <div>
        <label htmlFor="expert_phone" className="block text-sm font-medium mb-1">Phone/WhatsApp *</label>
        <input
          type="tel"
          name="phone"
          id="expert_phone"
      ...
      <div>
        <label htmlFor="expert_location" className="block text-sm font-medium mb-1">Location/Region *</label>
        <input
          type="text"
          name="location"
          id="expert_location"
          required
          className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100"
          placeholder="e.g., Victoria Falls, Hwange, Harare"
        />
      </div>
    </div>

    <div>
      <label htmlFor="expert_category" className="block text-sm font-medium mb-1">Expert Category *</label>
      <select
      ...
      >
        ...
        <option value="safari_guide">Safari Guide (Wildlife)</option>
        <option value="bird_guide">Birding Specialist</option>
        <option value="walking_safari">Walking Safari Guide</option>
        <option value="photography_guide">Photography Guide</option>
        <option value="cultural_expert">Cultural & Heritage Expert</option>
        <option value="adventure_guide">Adventure Activity Guide</option>
        <option value="hiking_guide">Hiking & Trekking Guide</option>
        <option value="fishing_guide">Fishing Guide</option>
        <option value="city_guide">Urban/City Guide</option>
        <option value="food_culinary">Food & Culinary Expert</option>
        <option value="art_crafts">Arts & Crafts Specialist</option>
    ...
    <div>
      <label htmlFor="expert_years" className="block text-sm font-medium mb-1">Years of Experience *</label>
      <select
    ...
    <div>
      <label htmlFor="expert_certifications" className="block text-sm font-medium mb-1">Certifications & Qualifications *</label>
      <textarea
        name="certifications"
        id="expert_certifications"
        required
        rows="3"
        className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100"
    ...
    <div>
      <label htmlFor="expert_languages" className="block text-sm font-medium mb-1">Languages Spoken *</label>
      <input
        type="text"
        name="languages"
        id="expert_languages"
    ...
    <div>
      <label htmlFor="expert_services" className="block text-sm font-medium mb-1">Services You Offer *</label>
      <textarea
        ...
        rows="4"
        className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100"
        placeholder="Describe the experiences and services you offer to travelers (e.g., full-day game drives, walking safaris, cultural village tours, photography workshops)"
      ></textarea>
    </div>

    <div>
      <label htmlFor="expert_why" className="block text-sm font-medium mb-1">Why do you want to join our network? *</label>
      <textarea
        name="motivation"
        id="expert_why"
        required
        rows="3"
        className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100"
        placeholder="Share your passion for Zimbabwe and why you want to connect with travelers through our platform"
      ></textarea>
    </div>

    <div>
      <label htmlFor="expert_website" className="block text-sm font-medium mb-1">Website or Social Media (optional)</label>
      <input
        type="url"
        name="website"
        id="expert_website"
...
<Note>
**What happens next?** Our team will review your application within 5-7 business days. If your qualifications meet our standards, we'll schedule a video interview to learn more about your expertise and verify your credentials.
</Note>
