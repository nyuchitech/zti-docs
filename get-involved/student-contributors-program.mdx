...
description: "Join Zimbabwe Travel Information as a student contributor and share your unique perspective on Zimbabwe's destinations"
---
...
## Student Contributor Showcase

<Tabs>
  <Tab title="Victoria Moyo - UZ">
    <Frame>
      <img src="/api/placeholder/800/400" alt="Victoria's feature on Binga" className="rounded-lg" />
    </Frame>
    
    Victoria's feature on Binga provided insights into this lakeside destination that weren't available anywhere else online. Her personal connection to the region brought authenticity to the piece.
    
    *"Being published on Zimbabwe Travel Information helped me land an internship with a major tour operator. The editorial process taught me skills I couldn't learn in the classroom."* — Victoria Moyo, University of Zimbabwe
  </Tab>
  <Tab title="Takudzwa Chikoore - MSU">
    <Frame>
      <img src="/api/placeholder/800/400" alt="Takudzwa's guide to Chimanimani" className="rounded-lg" />
    </Frame>
    
    Takudzwa's comprehensive guide to hiking trails in Chimanimani combined practical information with stunning photography, creating one of our most-viewed destination guides of 2024.
    
    *"The mentorship I received helped transform my writing from academic to engaging. Seeing my work published gave me the confidence to pursue travel writing professionally."* — Takudzwa Chikoore, Midlands State University
  </Tab>
  <Tab title="Melody Dube - NUST">
    <Frame>
      <img src="/api/placeholder/800/400" alt="Melody's feature on Matobo Hills cultural experiences" className="rounded-lg" />
    </Frame>
    
    Melody's unique perspective on cultural experiences in Matobo Hills highlighted community-based tourism initiatives that travelers might otherwise miss.
    
    *"Contributing to Zimbabwe Travel Information allowed me to share stories from my community that weren't being told. The platform helped me develop as a writer while promoting sustainable tourism in my region."* — Melody Dube, National University of Science and Technology
  </Tab>
</Tabs>
...
We're proud to work with faculty from these Zimbabwean institutions:

<CardGroup cols={4}>
  <Card>
    <img src="/api/placeholder/150/150" alt="University of Zimbabwe logo" />
  </Card>
  <Card>
    <img src="/api/placeholder/150/150" alt="Midlands State University logo" />
  </Card>
  <Card>
    <img src="/api/placeholder/150/150" alt="National University of Science and Technology logo" />
  </Card>
  <Card>
    <img src="/api/placeholder/150/150" alt="Harare Institute of Technology logo" />
  </Card>
</CardGroup>
...
- Discord: Join our [Zimbabwe Travel Platform community](https://discord.gg/zimbabwetravel)
